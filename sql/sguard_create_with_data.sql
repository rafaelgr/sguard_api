...
insert  into `rondas`(`rondaId`,`nombre`,`tag`,`tagf`) values (1,'Ronda Exterior 1500',NULL,NULL),(2,'Ronda Interior',NULL,NULL),(11,'La ronda de noche',NULL,NULL);
...
insert  into `rondaspuntos`(`rondaPuntoId`,`orden`,`rondaId`,`puntoId`) values (1,1,1,1),(4,1,2,1),(14,2,1,2),(15,1,11,1),(16,2,11,2);
